...
public class IoTConfigDAO
{
    ...
    public Optional<IotConfig> buscarPorId(int id) throws SQLException
    {
    ...
    public Optional<IotConfig> buscarPorMesa(int idMesa) throws SQLException
    {
    ...
    public void atualizarStatus(int id, boolean online) throws SQLException {
    ...
    public void atualizarFirmware(int id, String versao) throws SQLException
    {
