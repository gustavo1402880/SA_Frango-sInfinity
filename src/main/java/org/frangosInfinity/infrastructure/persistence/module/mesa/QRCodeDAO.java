...
public class QRCodeDAO
{
    ...
    public Optional<QRCode> buscarPorId(int id) throws SQLException
    {
    ...
    public Optional<QRCode> buscarAtivoPorMesa(int idMesa) throws SQLException
    {
    ...
    public List<QRCode> listarPorMesa(int idMesa) throws SQLException
    {
    ...
    public void marcarComoUtilizado(int id) throws SQLException
    {
